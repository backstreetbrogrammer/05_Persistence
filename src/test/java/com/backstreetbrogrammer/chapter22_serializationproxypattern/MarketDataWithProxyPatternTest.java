...
public class MarketDataWithProxyPatternTest {
    ...
    void setUp() throws IOException {
        final var serPath = Path.of("src", "test", "resources",
                "MarketDataWithProxyPatternTest.ser");
    ...
    @Test
    @DisplayName("Test basic serialization for Java POJO with proxy pattern")
    ...
    @Test
    @DisplayName("Test basic deserialization for Java POJO with proxy pattern")
    void testDeserialize() throws IOException, ClassNotFoundException {
        try (final var ois = new ObjectInputStream(
            ...
            final var fromSerialize = (MarketDataWithProxyPattern) ois.readObject();
