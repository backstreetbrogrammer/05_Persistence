...
public class MarketDataWithReferenceObjectsTest {

    private File serFile;
    private final MarketDataProvider marketDataProvider = new MarketDataProvider("REUTERS");

    @BeforeEach
    void setUp() throws IOException {
        final var serPath = Path.of("src", "test", "resources", "MarketDataWithReferenceObjectsTest.ser");
    ...
    @Test
    @DisplayName("Test basic serialization for Java POJO with reference objects")
    void testSerialize() throws IOException {
        final var marketData = new MarketDataWithReferenceObjects();
    ...
    @Test
    @DisplayName("Test basic deserialization for Java POJO with reference objects")
    void testDeserialize() throws IOException, ClassNotFoundException {
        try (final var ois = new ObjectInputStream(
            ...
            final var fromSerialize = (MarketDataWithReferenceObjects) ois.readObject();
