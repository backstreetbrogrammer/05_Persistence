...
public class MarketDataWhitelistingTest {

    private File serFile;
    private final MarketDataProviderWhitelisting marketDataProvider
            = new MarketDataProviderWhitelisting("CHIX");

    @BeforeEach
    void setUp() throws IOException {
        final var serPath = Path.of("src", "test", "resources", "MarketDataWhitelistingTest.ser");
    ...
    @Test
    @DisplayName("Test basic serialization for Java POJO with whitelisting")
    void testSerialize() throws IOException {
        final var marketData = new MarketDataWhitelisting();
    ...
    @Test
    @DisplayName("Test basic deserialization for Java POJO with whitelisting")
    void testDeserialize() throws IOException, ClassNotFoundException {
        try (final var ois = new ObjectInputStream(
            ...
            final var fromSerialize = (MarketDataWhitelisting) ois.readObject();
            ...
            assertNull(marketDataProvider1);
        }
    }
}
