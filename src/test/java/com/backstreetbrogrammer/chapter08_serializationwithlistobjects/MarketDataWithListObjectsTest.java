...
public class MarketDataWithListObjectsTest {

    private File serFile;

    @BeforeEach
    void setUp() throws IOException {
        final var serPath = Path.of("src", "test", "resources", "MarketDataWithListObjectsTest.ser");
    ...
    @Test
    @DisplayName("Test basic serialization for Java POJOs as list")
    void testSerialize() throws IOException {
        ...
        final var marketDataObjects =
                List.of(marketData1, marketData2);
    ...
    @Test
    @DisplayName("Test basic deserialization for Java POJOs as list")
    void testDeserialize() throws IOException, ClassNotFoundException {
        try (final var ois = new ObjectInputStream(
            ...
            final var marketData1 = marketDataObjects.get(0);
            ...
            final var marketData2 = marketDataObjects.get(1);
